...
export const enum IpcEvents {
    ...
    AUDIO_TOGGLE_MUTE = "VCD_AUDIO_TOGGLE_MUTE",
    AUDIO_TOGGLE_DEAFEN = "VCD_AUDIO_TOGGLE_DEAFEN",
    AUDIO_UPDATE_STATE_MUTED = "VCD_AUDIO_UPDATE_STATE_MUTED",
    AUDIO_UPDATE_STATE_DEAFENED = "VCD_AUDIO_UPDATE_STATE_DEAFENED",
