...
export const enum IpcEvents {
    ...
    UPDATER_INSTALL = "VCD_UPDATER_INSTALL",
    UPDATER_DOWNLOAD_PROGRESS = "VCD_UPDATER_DOWNLOAD_PROGRESS",
    UPDATER_ERROR = "VCD_UPDATER_ERROR",
    UPDATER_SNOOZE_UPDATE = "VCD_UPDATER_SNOOZE_UPDATE",
    UPDATER_IGNORE_UPDATE = "VCD_UPDATER_IGNORE_UPDATE",
