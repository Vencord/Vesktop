...
export const enum IpcEvents {
    ...
    SAFE_STORAGE_IS_AVAILABLE = "VCD_SAFE_STORAGE_IS_AVAILABLE",
    SAFE_STORAGE_ENCRYPT_STRING = "VCD_SAFE_STORAGE_ENCRYPT_STRING",
    SAFE_STORAGE_DECRYPT_STRING = "VCD_SAFE_STORAGE_DECRYPT_STRING"
}
